package com.gwt.HealthyEating.client;
 ...
 */
public class HealthyEating implements EntryPoint, ValueChangeHandler {
	...
	Button send = new Button("Log new entry");
